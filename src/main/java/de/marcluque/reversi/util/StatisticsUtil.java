...
public class StatisticsUtil {
    ...
    public static void printStatistics(int depth, Move chosenMove, int totalStates, int leafStates,
        ...
        System.out.printf(PREFIX + "%s%n" + ANSI_RESET,
                "Mean branching factor (total states / non-terminal (non-leaf) states):", meanBranchingFactor);
        ...
        System.out.printf(PREFIX + "%d%n" + ANSI_RESET,
                String.format("Computation time up to (including) depth %d (ms):", depth), totalTimeUntilDepth);
